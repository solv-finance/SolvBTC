...
export class AuthData {
  public static async getAuthContracts(): Promise<AuthContractConfig[]> {
    return [
      ...
      ["SolvBTCYieldTokenMultiAssetPool", LstInfos.SolvBTCYieldTokenMultiAssetPoolAddresses[network.name], "transferAdmin"],
      ...
      ["SolvBTCYieldTokenRouter", (await deployments.getOrNull("SolvBTCYieldTokenRouterProxy"))?.address, "transferAdmin"],
