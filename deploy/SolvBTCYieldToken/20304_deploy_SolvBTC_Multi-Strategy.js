...
module.exports = async ({ getNamedAccounts, deployments, network }) => {
  ...
  const productName = "SolvBTC Multi-Strategy";
  const tokenName = "SolvBTC.Multi-Strategy";
  const tokenSymbol = "SolvBTC.Multi-Strategy";
...
module.exports.tags = ['SolvBTCV3_Multi-Strategy']
